  ...
  const onSubmit = async (data: SignupFormData) => {
    ...
    try {
      ...
      if (err.message?.includes('user_already_exists') || err.message?.includes('already exists')) {
        ...
        setError('Permission denied. Please check your Appwrite configuration.');
      } else {
